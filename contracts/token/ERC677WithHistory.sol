...
import "./ERC677.sol";
import "./IERC677WithHistory.sol";


/**
 * @dev A token that holds a history of any of it's moves
*/
contract ERC677WithHistory is ERC677, IERC677WithHistory {
    ...
    */
    ...
    constructor(string memory name_, string memory symbol_) public ERC677(name_, symbol_) {}
